...
var runtimeCode = [
  fs.readFileSync(__dirname + '/../node_modules/regenerator/runtime/dev.js').toString(),
  fs.readFileSync(__dirname + '/../runtime/compiled/array.js').toString()
];

Machine.prototype.$bootstrapRuntime = function () {
  runtimeCode.forEach(function (source) {
    console.log(source)
    this
      .$evaluate(source)
      .run();
